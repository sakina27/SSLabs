 ...
 * Reg No - Mt2024130
 * Problem Statement: 18. Write a program to perform Record locking.
...
int main(){
	...
	int fd = open("recordFile.txt", O_RDWR | O_CREAT, 0666);
 ...
 *
 *
 * sakina@sakina-VivoBook-ASUSLaptop-X515EA-X515EA:~/my-repo$ ./18
Record 1 locked...
Writing in Record 1
Record 1 updated
Record 1 unlocked.
